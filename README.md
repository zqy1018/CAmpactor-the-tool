...
- This repository contains a parser for the [CTWedge input language](https://github.com/fmselab/ctwedge/wiki/Grammar) and an accompanying Python3 script, allowing users to write human-readable input files for describing the system under test and to obtain human-readable CSV files for describing the PCA.  
